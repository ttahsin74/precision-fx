  ...
  return (
    <div className="xl:bg-transparent hero-bg ">
      <div className="xl:bg-[#090d16] bg-[#090d16ec]">
        <Container>
          <Flex className="justify-between w-full items-center gap-5 xl:pt-[60px] pt-7 sm:pt-9 lg:pt-8 pb-12 lg:pb-[100px]">
            <div className=" xl:w-1/2 text-[#fff] ">
              <h1 className="font-[700] lg:text-[55px] text-[32px] sm:text-[40px]  text-center xl:text-left text-[#da871b] leading-snug">
                A Map To Navigating The Market.
              </h1>
              <p className="lg:mb-[50px] mb-7 lg:text-[18px] text-[14px] sm:text-base text-center xl:text-left tracking-[.10em] mt-5 ">
